# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-10-11 12:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attached_file', models.FileField(blank=True, upload_to=b'files')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ava', models.ImageField(blank=True, upload_to=b'avatars')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attached_file', models.FileField(blank=True, upload_to=b'files')),
                ('create_date', models.DateTimeField(default=django.utils.timezone.now, verbose_name=b'\xd0\x94\xd0\xb0\xd1\x82\xd0\xb0 \xd1\x81\xd0\xbe\xd0\xb7\xd0\xb4\xd0\xb0\xd0\xbd\xd0\xb8\xd1\x8f')),
                ('ticket', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='usercomments', to='tickets.Ticket')),
